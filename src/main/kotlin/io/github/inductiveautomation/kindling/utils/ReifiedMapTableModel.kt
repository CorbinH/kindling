...
class ReifiedMapTableModel<V>(
    ...
    ReifiedTableModel<Map.Entry<String, V>> {
    ...
    override fun getValueAt(rowIndex: Int, columnIndex: Int): Any? = columns[columnIndex].getValue(data.entries.toList()[rowIndex])
