...
import io.github.inductiveautomation.kindling.docker.model.PortMapping.Companion.DEFAULT_HOST_IP
...
class PortMappingEditor(
    ...
    private inner class PortEditingPanel() : JPanel(MigLayout("fill, flowy")) {
        ...
        val protocolEntry = JComboBox<String>(arrayOf("tcp", "udp")).apply {
